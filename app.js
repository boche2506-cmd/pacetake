...
function renderDynamicMenu(role) {
    ...
    menuHTML += `
        <div class="menu-divider"></div>
        <button id="logoutBtn" style="color: var(--brand-red); width: 100%; text-align: left; padding: 0.125rem; background: none; border: none; cursor: pointer; font-size: 1rem;">🚪 登出系統</button>
    `;
