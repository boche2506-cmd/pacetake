...
function renderDynamicMenu(role) {
    ...
    menuHTML += `
        <div class="menu-divider"></div>
        <button id="logoutBtn" style="color: var(--brand-red); width: 60%; text-align: left; padding: 0.5rem; background: none; border: none; cursor: pointer; font-size: 0.75rem;">🚪 登出系統</button>
    `;
...
function updateUIForUser(user, currentRole) {
    ...
    if (userNameDisplay) {
        if (currentRole === "admin") {
            ...
            userNameDisplay.innerHTML = `<img src="logo.png" alt="買家圖示" style="font-size: 0.625rem; width: 100%; height: 40%;"> 買家`;
        }
    }
