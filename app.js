...
function updateUIForUser(user, currentRole) {
    ...
    if (userNameDisplay) {
        if (currentRole === "admin") {
            ...
            userNameDisplay.innerHTML = `<img src="logo.png" class="buyer" alt="買家圖示" style="display: inline-block; flex-direction: row; justify-content: center; align-items: center;"> 買家`;
        }
    }
